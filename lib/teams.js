...
const { teamCap } = require('./settings');
...
// plumbing on top of the pooled tagged-template client.
async function formTeam(divisionKey, playerIdA, playerIdB, settings) {
  ...
  if (countRows[0].c >= teamCap(settings, divisionKey)) {
